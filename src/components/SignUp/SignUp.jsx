...
import locobrand from '../logo/signup.png'
      ...
      {props => {
        ...
        return (
          <div className='validate-layout container-fluid' >
            <MDBRow>
              <MDBCol col='4' md='6'>
                <img src={locobrand} width={1000} class="img-fluid" alt="Sample image" />
              </MDBCol>
              <MDBCol col='10' md='6'>
                <div className="d-flex flex-row align-items-center justify-content-center">

                  <p className="lead fw-normal mb-0 me-3"><b>SIGN UP FORM</b></p>
                </div>
                <form onSubmit={handleSubmit} >
                  ...
                  <button type="submit" disabled={isSubmitting} className='mb-2 px-5'>
                    SignUp
                  </button>
