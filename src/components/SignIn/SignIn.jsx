...
import locobrand from '../logo/signin.png'
          ...
          <div className='validate-layout container-fluid' >
            ...
            <MDBCol col='4' md='6'>
              <div className="d-flex flex-row align-items-center justify-content-center">
                ...
                <p className="lead fw-normal mb-0 me-3"><b>SIGN IN FORM</b></p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" disabled={isSubmitting} className='mb-0 px-5'>
                  Login
                </button>
            ...
            <MDBCol col='10' md='6'>
              <img src={locobrand} width={800} class="img-fluid" alt="Sample image" />
            </MDBCol>
            </MDBRow>
          </div>
